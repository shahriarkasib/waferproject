...
class trainModel:
    ...
    def __init__(self,client, resource):
        ...
        self.db_obj = training_log_insertion_to_db('TrainModel')
    ...
    def trainingModel(self):
        ...
        try:
            ...
            data_db = {'objective': 'training', 'status':'ok','error':'', 'message': "Got Training Data from DataBase",
                    'time': dt.now().strftime("%d/%m/%Y %H:%M:%S")}
            self.db_obj.insert_data(data_db)
            """doing the data preprocessing"""
            data_db = {'objective': 'training', 'status':'ok','error':'', 'message': "Start Prepearing Data for Training",
                    'time': dt.now().strftime("%d/%m/%Y %H:%M:%S")}
            self.db_obj.insert_data(data_db)
            ...
            data_db = {'objective': 'training', 'status':'ok','error':'', 'message': "Successful End of Training",
                    'time': dt.now().strftime("%d/%m/%Y %H:%M:%S")}
            self.db_obj.insert_data(data_db)
